...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { description: @deal.description, image_url: @deal.image_url, price: @deal.price, title: @deal.title }
    end
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { description: @deal.description, image_url: @deal.image_url, price: @deal.price, title: @deal.title }
    assert_redirected_to deal_path(assigns(:deal))
  end
